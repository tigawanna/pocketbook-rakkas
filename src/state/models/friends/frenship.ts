...
import { CreateFrienshipMutaionProps, UpdateFriendShipMutationProps } from "./types";
...
export function shouldFollowUnfollowOrFollowBack({
    ...
    if (user_a === logged_in_id && user_b === profile_id) {
        ...
        } else if (user_b_follow_user_a === "yes" && user_a_follow_user_b === "no") {
    ...
    if (user_b === logged_in_id && user_a === profile_id) {
        ...
        } else if (user_a_follow_user_b === "yes" && user_b_follow_user_a === "no") {
